...
/*   Updated: 2019/11/27 18:01:25 by crenly-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_live(t_game *game, t_carriage *car); // 1
void    		ft_ld(t_game *game, t_carriage *car);
void    		ft_st(t_game *game, t_carriage *car);
void    		ft_add(t_game *game, t_carriage *car);
void    		ft_sub(t_game *game, t_carriage *car);
void    		ft_and(t_game *game, t_carriage *car);
void   			ft_or(t_game *game, t_carriage *car);
void    		ft_xor(t_game *game, t_carriage *car); // 8
